...
// Tue Nov 12 16:31:54 2024 by ROOT version 6.32.06
// from TTree output/output
// found on file: eos_data-fiber_calibration-5-3-run-623.0.ntuple.root
//////////////////////////////////////////////////////////

#ifndef PracticeClass_h
#define PracticeClass_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   PracticeClass(TTree *tree=0);
   virtual ~PracticeClass();
...
#ifdef PracticeClass_cxx
PracticeClass::PracticeClass(TTree *tree) : fChain(0) 
{
...
Int_t PracticeClass::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t PracticeClass::LoadTree(Long64_t entry)
{
...
void PracticeClass::Init(TTree *tree)
{
...
void PracticeClass::Show(Long64_t entry)
{
...
Int_t PracticeClass::Cut(Long64_t entry)
{
