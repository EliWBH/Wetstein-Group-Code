...
// Wed Nov 13 20:05:29 2024 by ROOT version 6.30/08
...
#ifdef metaData_cxx
metaData::metaData(TTree *tree) : fChain(0) 
{
...
Int_t metaData::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t metaData::LoadTree(Long64_t entry)
{
...
void metaData::Show(Long64_t entry)
{
...
Int_t metaData::Cut(Long64_t entry)
{
