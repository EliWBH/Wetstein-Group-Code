...
// Thu Feb 27 12:25:04 2025 by ROOT version 6.34.02
...
#ifdef dataMap_cxx
dataMap::dataMap(TTree *tree) : fChain(0) 
{
...
Int_t dataMap::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t dataMap::LoadTree(Long64_t entry)
{
...
void dataMap::Show(Long64_t entry)
{
...
Int_t dataMap::Cut(Long64_t entry)
{
